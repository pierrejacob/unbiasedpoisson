...
g
ggsave(filename = "../output/highdimreg.classicavar2e4.pdf", plot = g, width = 8, height = 5)
...
g <- g + geom_hline(yintercept =  mean(results_uavar), col = "red") +  geom_hline(yintercept = c(estim_lo, estim_hi), linetype = "dashed", color = "red")
g
ggsave(filename = "../output/highdimreg.classicavar2e5.pdf", plot = g, width = 8, height = 5)
```
