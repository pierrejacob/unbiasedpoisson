...
Here we conclude that $v(P,h)$ for the HMC sampler is around 2.
...
g
ggsave(filename = "../output/randomeffects.hmc.classicavar1e4.pdf", plot = g, width = 8, height = 5)
...
g <- g + geom_hline(yintercept =  mean(results.hmc), col = "red") +  geom_hline(yintercept = c(estim_lo, estim_hi), linetype = "dashed", color = "red")
g
ggsave(filename = "../output/randomeffects.hmc.classicavar1e5.pdf", plot = g, width = 8, height = 5)
